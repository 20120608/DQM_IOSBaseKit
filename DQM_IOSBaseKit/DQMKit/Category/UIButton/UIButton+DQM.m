...
+ (UIButton *)initWithFrame:(CGRect)frame buttonTitle:(NSString *)buttonTitle
  ...
  UIButton *solidColorButton = [[UIButton alloc]initWithFrame:frame buttonTitle:buttonTitle normalColor:normalColor cornerRadius:cornerRadius doneBlock:doneBlock];
  return solidColorButton;
}
